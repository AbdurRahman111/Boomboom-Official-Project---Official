...
class Migration(migrations.Migration):
    ...
    operations = [
        migrations.AlterField(
            ...
            name='end_time',
            field=models.DateField(blank=True, default=datetime.datetime(2021, 9, 20, 13, 39, 36, 908752), null=True),
        ),
        migrations.AlterField(
            model_name='campaign_table',
            name='start_time',
        ...
        migrations.AlterField(
            model_name='products',
            name='Time',
            field=models.DateTimeField(blank=True, default=datetime.datetime(2021, 9, 20, 13, 39, 36, 893093)),
        ),
        migrations.AlterField(
            model_name='products',
            name='flash_sell_end_time',
